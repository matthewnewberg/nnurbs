...
namespace NN.Geometry
{
    ...
    public struct Interval : ISerializable, IEquatable<Interval>, IComparable<Interval>, IComparable, IEpsilonComparable<Interval>
    {
        ...
        public bool CopyFrom(Rhino.Geometry.Interval from)
        {
            m_t0 = from.T0;
            m_t1 = from.T1;
            return true;
        ...
        public bool CopyTo(Rhino.Geometry.Interval to)
        {
            to.T0 = m_t0;
            to.T1 = m_t1;
            return true;
        ...
        public Rhino.Geometry.Interval RhinoObject()
        {
            return new Rhino.Geometry.Interval(m_t0, m_t1);
        }
#endif
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the NN.Geometry.Interval class.
        /// </summary>
        ...
        /// </summary>
        /// <param name="other">The NN.Geometry.Interval to use as a base.</param>
    ...
    public struct Point3d : ISerializable, IEquatable<Point3d>, IComparable<Point3d>, IComparable, IEpsilonComparable<Point3d>
    {
        ...
        public bool CopyFrom(Rhino.Geometry.Point3d from)
        {
            if (from == null)
                return false;
        ...
        public bool CopyTo(Rhino.Geometry.Point3d t)
        {
            return true;
        }

        public Rhino.Geometry.Point3d RhinoObject()
        {
            return new Rhino.Geometry.Point3d(m_x, m_y, m_z);
        }
#endif
        ...
        {
            return new Point3d(point.m_x + vector.v.X, point.m_y + vector.v.Y, point.m_z + vector.v.Z);
        }
        ...
        {
            return new Point3d(point.m_x + vector.v.Z, point.m_y + vector.v.Z, point.m_z + vector.v.Z);
        }
        ...
        public static Point3d[] CullDuplicates(System.Collections.Generic.IEnumerable<Point3d> points, double tolerance)
        {
            ...
            NN.Collections.Point3dList point_list = new NN.Collections.Point3dList(points);
            int count = point_list.Count;
            if (0 == count)
                return null;

            bool[] dup_list = new bool[count];
            NN.Collections.Point3dList non_dups = new NN.Collections.Point3dList(count);
    ...
    public struct Point4d : ISerializable, IEquatable<Point4d>, IEpsilonComparable<Point4d>
    {
        ...
        public bool CopyFrom(Rhino.Geometry.Point4d from)
        {
            if (from == null)
                return false;
        ...
        public bool CopyTo(Rhino.Geometry.Point4d to)
        {
        ...
        public Rhino.Geometry.Point4d RhinoObject()
        {
            return new Rhino.Geometry.Point4d(m_x, m_y, m_z, m_w);
        }
#endif
    ...
    public struct Vector3d : ISerializable, IEquatable<Vector3d>, IComparable<Vector3d>, IComparable, IEpsilonComparable<Vector3d>
    {
        ...
        public bool CopyFrom(Rhino.Geometry.Vector3d from)
        {
            if (from == null)
                return false;
        ...
        public bool CopyTo(Rhino.Geometry.Vector3d t)
        {
            t.X = m_x;
            t.Y = m_y;
            t.Z = m_z;
        ...
        public Rhino.Geometry.Vector3d RhinoObject()
        {
            return new Rhino.Geometry.Vector3d(m_x, m_y, m_z);
        }
#endif
        ...
        {
            if (Math.Abs(m_x) < tolerance && Math.Abs(m_y) < tolerance && Math.Abs(m_z) < tolerance)
                return true;
